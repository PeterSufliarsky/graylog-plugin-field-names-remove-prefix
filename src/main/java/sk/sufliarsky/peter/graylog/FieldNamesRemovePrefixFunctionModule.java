 ...
 */
public class FieldNamesRemovePrefixFunctionModule extends PluginModule {
    ...
    protected void configure() {
        addMessageProcessorFunction(FieldNamesRemovePrefixFunction.NAME, FieldNamesRemovePrefixFunction.class);
    }
